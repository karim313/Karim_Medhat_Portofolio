          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="image-container" style={{ height: '240px', overflow: 'hidden', position: 'relative' }}>
                ...
                <div className="overlay" style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(3, 0, 20, 0.9), transparent)', opacity: 0, transition: 'opacity 0.3s ease', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
