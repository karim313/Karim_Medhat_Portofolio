            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <div style={{ fontWeight: 600 }}>01113067398</div>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <div style={{ fontWeight: 600 }}>kareemmedhat03@gmail.com</div>
                </div>
              </div>
            </div>
          </div>
              ...
              {formState !== 'success' ? (
                ...
                >
                  ...
                  <button 
                    ...
                    style={{ marginTop: '2rem', background: 'none', border: '1px solid rgba(255,255,255,0.2)', padding: '0.6rem 1.5rem', borderRadius: '50px', color: 'white', cursor: 'pointer' }}
                  >
                    Send Another
                  </button>
                </motion.div>
